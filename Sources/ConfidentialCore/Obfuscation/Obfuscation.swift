...
///
/// > Important: The ``ConfidentialCore`` library was designed to be used in
///          conjunction with `#Obfuscate` macro and, as such, it  only ships
///          with a subset of API needed for deobfuscating obfuscated secret
///          data embedded in the application code.
