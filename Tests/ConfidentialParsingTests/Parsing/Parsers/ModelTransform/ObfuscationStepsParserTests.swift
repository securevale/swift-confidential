...
final class ObfuscationStepsParserTests: XCTestCase {
    ...
    private typealias ObfuscationStepParserSpy = ParserSpy<Substring, Obfuscation.Step>

    private typealias SUT = ObfuscationStepsParser<
        OneOfBuilder<Substring, Obfuscation.Step>.OneOf2<ObfuscationStepParserSpy, ObfuscationStepParserSpy>
    >
